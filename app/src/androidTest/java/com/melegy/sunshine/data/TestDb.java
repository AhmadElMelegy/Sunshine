 ...
 */
package com.melegy.sunshine.data;
...
public class TestDb extends AndroidTestCase {
    ...
    */
    ...
    public void testWeatherTable() {
        ...
        long rowId = db.insert(WeatherContract.WeatherEntry.TABLE_NAME, null, weatherTestValues);
        assertTrue(rowId != -1);
        // Query the database and receive a Cursor back
        Cursor cursor = db.query(WeatherContract.WeatherEntry.TABLE_NAME, null, null, null, null, null, null);
        // Move the cursor to a valid database row
        assertTrue("Error: No records returned from weather table", cursor.moveToFirst());
        // Validate data in resulting Cursor with the original ContentValues
        // (you can use the validateCurrentRecord function in TestUtilities to validate the
        // query if you like)
        TestUtilities.validateCursor("Error: Weather query validation failed", cursor, weatherTestValues);
        assertFalse("Error: More than one record returned form the query", cursor.moveToNext());
